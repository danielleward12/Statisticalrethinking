...
This notation is saying that the counts of water and land are distributed binomially, with the probability of ‘water’ on each toss. The entire range of possible values for p (which are (0,1)) are equally plausible.
...
**Aim of chapter - produce a posterior distribution and summarize/interpret it** You sample from the posterior distributions to summarize it
